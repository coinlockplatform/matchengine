...
<%@page import="java.io.PrintWriter, java.sql.*"%>
 ...
 double btcTradeAmount = Double.parseDouble(request.getParameter("protect_amount_matched"));
...
<body> -->
 ...
 <div style="display: inline-block;">  
  ...
  <form>
<br/>
 <h3>Match Trade # <%=request.getParameter("match_id") %></h5>
 <table style="background-color: #aaddaa; border: 1px solid black;  ">
   <tr>
         <th colspan="2" >Lock Coin Valuation in USD</th>	
   </tr>
   <tr>
         <td>MatchEngine</td><td ><input type="checkbox" name="freezeOpen" id="freezeOpen" value="" /></td>
   </tr>  
   <tr>
         <td>Current BTC $</td><td ><input type="text" name="c57" id="c57" value="" /></td>
   </tr>  
 </table> 
  <br/>
 <table style="background-color: #aaddaa; border: 1px solid black;  " >
   <tr>
         <td  >Amount of Protected BTC </td><td style="background-color: #aaddaa; "><input type="text" name="e100" id=e100 value="" style="background-color: #ffffff;"/></td>	
   </tr>
   <tr>
         <td>Protected $ Value</td><td style="background-color: #aaddaa; ">	<input type="text" name="e101" id="e101" value="" /></td>
   </tr>
   <tr>      
         <td>Current LOCK Price</td><td style="background-color: #aaddaa; ">	<input type="text" name="e102" id="e102" value="" /></td>
   </tr>  
 </table> 
 ...
 <table style="background-color: #aaddaa;"   >
   <tr>
         <th colspan="2" >Coin Lock  </th >	
   </tr>
   <tr>
         <td>Protector Ratio</td><td ><input type="text" name="e107" id="e107" value="" style="background-color: #ffffff;" /></td>
        
   </tr>  
 </table>
   <br/>
  <table style="background-color: #aaddaa;"   >
   <tr><th>Opening Protected BTC Balance</th><th>Opening Protector BTC Balance</th></tr>
   <tr><td><input type="text" name=d110 id="d110" value="" /></td><td><input type="text" name="e110" id="e110" value="" /></td></tr>	
 </table>
    <br/>
  <table style="background-color: #aaddaa;"   >
   <tr><th>Percent +/- Protected %</th><th>Percent +/- Protector</th></tr>
   <tr><td><input type="text" name="pd110" id="pd110" value="" /></td><td><input type="text" name="pe110" id="pe110" value="" /></td></tr>	
 </table>
    <br/>
  <table style="background-color: #aaddaa;"   >
   <tr><th>Closing Protected BTC Balance</th><th>Closing Protector BTC Balance</th></tr>
   <tr><td><input type="text" name="cd110" id="cd110" value="" /></td><td><input type="text" name="ce110" id="ce110" value="" /></td></tr>	
 </table>
    <br/>
  <table style="background-color: #aaddaa;"    >
   <tr><th>OPENING USD VALUE</th><th>CLOSING USD VALUE</th></tr>
   <tr><td><input type="text" name="d113" id="d113" value="" /></td><td><input type="text" name="e113" id="e113" value="" /></td></tr>	
 </table>
 ...
 <table style="background-color: #aaaadd; border: 1px solid black; display: none; ">
   ...
   <tr>
         <td>5% of Gain LOCK BONUS to Protected Holder</td><td >	<input type="text" name="e133" id="e133" value="" /></td>
   </tr>  
   <tr>
         <td>USD LOCK Bonus Value</td><td >	<input type="text" name="e135" id="e135" value="" /></td>
   </tr>  
   <tr>
         <td>USD LOCK Bonus to Referer</td><td >	<input type="text" name="e136" id="e136" value="" /></td>
   </tr>  
   <tr>
         <td>Return Price Protected Coinholder</td><td >	<input type="text" name="e137" id="e137" value="" /></td>
   </tr>  
   <tr>
         <td> Gain/Loss</td><td >	<input type="text" name="e138" id="e138" value="" /></td>
   </tr>  
   <tr>
         <td>Coin Lock Fee</td><td>	<input type="text" name="e139" id="e139" value="" /></td>
   </tr>  
   <tr>
         <td>BTC to MATCHENGINE</td><td >	<input type="text" name="e140" id="e140" value="" /></td>
   </tr>  
 </table> 
<input type="button" onclick="getLocPrice()" class='btn btn-hero' value="Calculate"/> 
 ...
 <form action="ExitMatchProtect" method="post">
 <h4>Closing Protected BTC Balance:</h4>
 ...
 <input type="text" name="exit_cd110" id="exit_cd110" value="" />
 <input type="hidden" name="exit_ce110" id="exit_ce110" value="" />
...
//         cd110.value=parseFloat(e125.value)-parseFloat(d110.value);
 ...
 ///////////////end new/////////////////////////
  ...
  var myVar = setInterval(getBtcPrice, 10);
   
</script>
     <%@ page import="java.sql.*" %>
     <%
      try{  
    	   //  String sql="Select * from Protect where name='"+request.getParameter("protect_email")+"' ORDER BY protect_id DESC;";
    	     String sql="Select * from Protect where name='"+username+"' ORDER BY protect_id DESC;";
     ResultSet rs = stmt.executeQuery(sql);
     out.println("<table width='100%' style='border-style: none;'><tr><td style='border-style: none;'>");
     out.println("<center><h4>Protect</h4>");
     out.println("<table>");
     ...
     while(rs.next()){
      ...
      //  String password = rs.getString("password");
        ...
        out.println("<tr><td>"+protect_id+"</td><td>"+name2+"</td><td>"+unmatched+"</td><td>"+matched+"</td></tr>");
     }
     out.println("</table></center>");
     out.println("</td><td style='border-style: none;'>");
     rs.close();
     sql="Select * from Trading where name='"+username+"' ORDER BY trade_id DESC;";
     ...
     while(rs.next()){
       ...
       // String password = rs.getString("password");
        ...
        double unmatched = rs.getDouble("unmatched");
        double matched = rs.getDouble("matched");
        out.println("<tr><td>"+trade_id+"</td><td>"+name3+"</td><td>"+unmatched+"</td><td>"+matched+"</td>");
     }
     out.println("</table></center>");
