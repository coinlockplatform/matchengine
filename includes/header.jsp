...
<head>
	...
	<title>MatchEngine - Modern Crypto Risk Market</title>
	...
	<script src="/global_assets/js/plugins/pickers/daterangepicker.js"></script>
        ...
        <script src="/assets/js/form_select2.js"></script>
    ...
    <div class="navbar navbar-expand-md navbar-dark navbar-static">
        <div class="navbar-brand wmin-0 mr-5">
            <a href="/" class="d-inline-block">
                <img src="/global_assets/images/matchengine-logo.png" alt="MATCHENGINE.IO"> 
            </a>
        </div>
        <div class="d-md-none">
