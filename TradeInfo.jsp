...
<%@page import="java.io.PrintWriter, java.sql.*,  java.util.ArrayList"%>
 <%
...
<body> -->
 ...
 <table style="background-color: #aaaadd; border: 1px solid black;  ">
   ...
   <tr>
         <td>Freeze BTC Opening</td><td ><input type="checkbox" name="freezeOpen" id="freezeOpen" value="" /></td>
   </tr>  
   <tr>
         <td>Opening BTC price</td><td ><input type="text" name="c57" id="c57" value="" /></td>
   </tr>  
 </table> 
  <br/>
 <table style="background-color: #aaddaa; border: 1px solid black;  " >
   ...
   <tr>
         <td>Current  BTC Price to Open</td><td style="background-color: #aaddaa; ">	<input type="text" name="e101" id="e101" value="" /></td>
   </tr>
   <tr>      
         <td>Current LOCK Price to Open</td><td style="background-color: #aaddaa; ">	<input type="text" name="e102" id="e102" value="" /></td>
   </tr>  
 </table> 
 ...
 <table style="background-color: #ddaaaa;"   >
   ...
   <tr>
         <td>Amount of leverage</td><td ><input type="text" name="e107" id="e107" value="" style="background-color: #ffffff;" /></td>
        
   </tr>  
 </table>
   <br/>
  <table style="background-color: #aaaaaa;"   >
   <tr><th>Opening Protect BTC Balance</th><th>Opening Leverage BTC Balance</th></tr>
  ...
  <table style="background-color: #aaaaaa;"   >
   ...
   <tr><td><input type="text" name="pd110" id="pd110" value="" /></td><td><input type="text" name="pe110" id="pe110" value="" /></td></tr>	
    ...
    <br/>
  <table style="background-color: #aaaaaa;"   >
   <tr><th>Closeing Protect BTC Balance</th><th>Closeing Leverage BTC Balance</th></tr>
    ...
    function parseJson(json) {
      ...
      document.getElementById("data").innerHTML = time + 
		   ...
		   "<br />" + lockCoinValue ; 
		     ...
		     e107.value=4;
		     e107.value=4;
		     e100.value=<%=fourTimesTradeAmount%>;
