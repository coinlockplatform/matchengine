					...
					<div class="col-xl-12 mt-5">
                        ...
                        <div class="row justify-content-md-center">
                            ...
                            <div id='login-form-cont' class="card logincontainer col-md-auto">
                                ...
                                <div class="card-body">
                                    <form action='/checkPassword.jsp' method=post' id='login-form'>
                                        <input type="email" class="email" id='login_email' name='username' placeholder="EMAIL" required title='you need to do this'><br /><div id='login_email_e' class='errormsg'></div>
                            ...
                            <div id='forgotpass-form-cont' class="card logincontainer col-md-auto">
                                ...
                                <div class="card-body">
                                    <form action='/forgotpass.jsp' id='forgotpass-form' method=post'>
                                        <input type="email" class="email" id='forgotpass_email' name='forgotpass_email' placeholder="EMAIL YOU REGISTERED WITH" required><br/><div id='forgotpass_email_e' class='errormsg'></div>
                                        <br/>
