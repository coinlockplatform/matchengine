    ...
    <div class="container pt100 pb100">
        <div class="col-md-8 col-sm-8 m-auto">
			<h3>Please login</h3>
                ...
                <form action="checkPassword.jsp" method="POST" name="contact" id="contact" novalidate>
                    <div class="text-center">
                        ...
                        <div class="form-group">
                            <button type="submit" value='Log In' name="submit" class="btn btn-hero">Submit</button>
                            <br />
