...
/**
 * Servlet implementation class SetUserCoinAdresses
 */
public class SetUserCoinAdresses extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SetUserCoinAdresses() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      String ethereum = request.getParameter("etherium");
	      String BTC = request.getParameter("BTC");
	      
	      PrintWriter out = response.getWriter();
	      out.println("<h1> in doRegistration   "+email+"  "+ethereum+" "+BTC+"</h1>");
			...
			try {
				...
				String sql;
				sql = "UPDATE users set  eth_address = '"+ethereum+"', btc_address = '"+BTC+"', approved = 1 where email="+email+");"; 
				stmt.executeUpdate(sql);
				//out.println("<h3>You are now part of the auction!!</h3>");
