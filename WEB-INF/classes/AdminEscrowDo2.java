...
/**
 * Servlet implementation class AdminEscrowDo2
 */
public class AdminEscrowDo2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminEscrowDo2() {
        super();
		...
		// out.println("hello");
	      ...
	      String password = request.getParameter("password");
 	      // JDBC driver name and database URL
 	       ...
 	       final String DB_URL="jdbc:mysql://6.13.62.130/cl";
...
/////////////////////////////////////////////////////////////////////////////////////////////
	         ...
	         while(rs.next()){
	    	   ...
	    	   out.println("<tr>");
	    		      ...
	    		      out.println("<td>");
	    		         String form ="<form action='SetUserCoinAdresses' method='POST'>"+
	     		    	  "<input type='text' id='etherium' name='etherium' value='etherium'>"+
	     		   		  "<input type='text' id='BTC' name='BTC' value='BTC'>"+
	     				  "<input type='hidden' id='email' name='email' value='"+email+"'>"+
	     				  
	     				  
	     				  "<input type='submit' value='Set Coin Addresses'>"+
	     				  "</form>";
	  	     		     out.println(form);
	    		      out.println("</td>");
             ...
             out.println("<table class='fixed_header' border='1' style='font-size:12px; margin-top=70px;'>");
	    		  ...
	    		  out.println("</th>");
	    		  out.println("<th>");
	    			out.println("Pending Amount");
	    		  out.println("</th>");
	    		  
	    		  out.println("<th>");
	    			out.println("BTC Address");
	    		  out.println("</th>");
	         ...
	         while(rs.next()){
	            ...
	            if(PendingBTCDep>0){
	    		      ...
	    		      out.println("</td>");
	    		      out.println("<td>");
	    			     out.println(PendingBTCDep);
	    		      out.println("</td>");
	    		      out.println("<td>");
	    			     out.println(btc_address);
	    		      out.println("</td>");
	    		      
	    		      out.println("<td>");
	    		         String form ="<form action='MoveFromPending' method='POST'>"+
	     		    	  "<input type='hidden' id='btc_holdings' name='btc_holdings' value='"+btc_holdings+"'>"+
	     		   		  "<input type='hidden' id='BTC' name='BTC' value='"+PendingBTCDep+"'>"+
	     				  "<input type='hidden' id='email' name='email' value='"+email+"'>"+
	     				  
	     				  
	     				  "<input type='submit' value='BTC Received'>"+
	     				  "</form>";
	  	     		     out.println(form);
	    		      out.println("</td>");
